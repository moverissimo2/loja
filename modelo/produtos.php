...
<body class="animsition">
	...
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(images/heading-pages-02.jpg);">
		...
		<p class="m-text13 t-center">
			Conheça nossas novidades para 2018
		</p>
	</section>
						...
						<div class="flex-w">
							<div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
								<select class="selection-2" name="sorting">
									<option>Listar por ordem</option>
									<option>Mais comprados</option>
									<option>Preço: menor para o Maior</option>
									<option>Preço: maior para o meno</option>
								</select>
							</div>
							...
							<div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
								<select class="selection-2" name="sorting">
									...
									<option>Mais de R$200.00</option>
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								...
								<div class="block2-txt p-t-20">
									<a href="detalhe.php" class="block2-name dis-block s-text3 p-b-5">
